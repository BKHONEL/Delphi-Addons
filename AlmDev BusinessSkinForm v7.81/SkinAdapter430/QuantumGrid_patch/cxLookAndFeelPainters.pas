...
type
  ...
  ['{7665EF58-2C4B-48B9-E1BE-BD5E135CA88F}']
  ...
  public
    ...
    class procedure DrawCheckBorder(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState); override;
    // header
    class procedure DrawHeaderPressed(ACanvas: TcxCanvas;
    ...
    class procedure DrawContent1(ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect; AState: Integer;
      AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
...
uses
  Messages,
  Forms, SysUtils, dxThemeConsts, cxControls, cxLookAndFeels, Math, bsUtils;
...
procedure DrawSkinButton2(Buffer: TBitMap; AState: TcxButtonState; var ATextColor: TColor);
var
  I: Integer;
  ...
  B1: TBitMap;
begin
 I := DevExSkinData.GetControlIndex('toolbutton');
 if I <> -1 then ButtonData := TbsDataSkinButtonControl(DevExSkinData.CtrlList[I]) else Exit;
 B1 := TBitMap.Create;
 with ButtonData do
 begin
   B1.Width := Buffer.Width;
   B1.Height := RectHeight(SkinRect);
      ...
      cxbsDefault, cxbsNormal:
        begin
          CreateHSkinImage(LTPoint.X, RectWidth(SkinRect) - RTPoint.X,
            B1, FSkinPicture, SkinRect, Buffer.Width, B1.Height, StretchEffect);
           ATextColor := FontColor;
        end;
      cxbsHot:
        begin
          CreateHSkinImage(LTPoint.X, RectWidth(SkinRect) - RTPoint.X,
            B1, FSkinPicture, ActiveSkinRect, Buffer.Width, B1.Height, StretchEffect);
          ATextColor := ActiveFontColor;
        end;
      cxbsPressed:
        begin
          CreateHSkinImage(LTPoint.X, RectWidth(SkinRect) - RTPoint.X,
            B1, FSkinPicture, DownSkinRect, Buffer.Width, B1.Height, StretchEffect);
          ATextColor := DownFontColor;
        end;
    end;
  end;
  Buffer.Canvas.StretchDraw(Rect(0, 0, Buffer.Width, Buffer.Height), B1);
  B1.Free;
end;

procedure DrawSkinButton(Buffer: TBitMap; AState: TcxButtonState; var ATextColor: TColor);
var
  I, XO, YO: Integer;
  R, NewClRect: TRect;
  ButtonData: TbsDataSkinButtonControl;
...
class function TcxUltraFlatLookAndFeelPainter.DefaultSelectionTextColor: TColor;
begin
...
class function TcxUltraFlatLookAndFeelPainter.DefaultSelectionColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
class function TcxUltraFlatLookAndFeelPainter.DefaultInactiveColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
class function TcxUltraFlatLookAndFeelPainter.DefaultInactiveTextColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawTab(ACanvas: TcxCanvas; R: TRect; ABorders: TcxBorders;
      const AText: string; AState: TcxButtonState; AVertical: Boolean; AFont: TFont;
...
class function TcxUltraFlatLookAndFeelPainter.DefaultTabColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
class function TcxUltraFlatLookAndFeelPainter.DefaultTabTextColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnText
...
class function TcxUltraFlatLookAndFeelPainter.DefaultTabsBackgroundColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
class function TcxUltraFlatLookAndFeelPainter.DefaultDateNavigatorHeaderColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
class function TcxUltraFlatLookAndFeelPainter.FooterSeparatorColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
class function TcxUltraFlatLookAndFeelPainter.DefaultDateNavigatorSelectionColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cHighlight
...
class function TcxUltraFlatLookAndFeelPainter.DefaultDateNavigatorSelectionTextColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cHighlightText
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawSmallExpandButton(ACanvas: TcxCanvas;
  R: TRect; AExpanded: Boolean; ABorderColor: TColor; AColor: TColor = clDefault);
begin
  DrawExpandButton(ACanvas, R, AExpanded, AColor);
end;

class procedure TcxUltraFlatLookAndFeelPainter.DrawFilterCloseButton(ACanvas: TcxCanvas;
  R: TRect; AState: TcxButtonState);
var
  Buffer: TBitMap;
  C: TColor;
begin
  ...
  then
    begin
      ...
      DrawSkinButton(BUffer, AState, C);
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawCheckButton(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
      AChecked: Boolean);
var
  AColor: TColor;
begin
 ...
 then
   begin
     DrawCheckBorder(ACanvas, R, AState);
     InflateRect(R, -CheckBorderSize, -CheckBorderSize);
     Acolor := DevExSkindata.SkinColors.cWindowText;
     case AState of
       cxbsDisabled: AColor := clGrayText;
       cxbsPressed: AColor := DevExSkindata.SkinColors.cBtnText;
     end;
...
class function TcxUltraFlatLookAndFeelPainter.CheckButtonColor(AState: TcxButtonState): TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    begin
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawHeaderPressed(ACanvas: TcxCanvas;
  const ABounds: TRect);
begin
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawContent1(ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect; AState: Integer;
      AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil; AIsFooter: Boolean = False);
const
...
class function TcxUltraFlatLookAndFeelPainter.DefaultGridLineColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    begin
...
class function TcxUltraFlatLookAndFeelPainter.DefaultFilterBoxColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
class function TcxUltraFlatLookAndFeelPainter.DefaultFilterBoxTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnHighLight
...
class function TcxUltraFlatLookAndFeelPainter.DefaultFooterColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
class function TcxUltraFlatLookAndFeelPainter.DefaultFooterTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
class function TcxUltraFlatLookAndFeelPainter.DefaultGroupByBoxColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
class function TcxUltraFlatLookAndFeelPainter.DefaultGroupByBoxTextColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnHighLight
...
class function TcxUltraFlatLookAndFeelPainter.DefaultContentColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
...
class function TcxUltraFlatLookAndFeelPainter.DefaultContentTextColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
...
class function TcxUltraFlatLookAndFeelPainter.DefaultGroupColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
class function TcxUltraFlatLookAndFeelPainter.DefaultGroupTextColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
class function TcxUltraFlatLookAndFeelPainter.DefaultHeaderBackgroundColor: TColor;
begin
   if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
class function TcxUltraFlatLookAndFeelPainter.DefaultHeaderBackgroundTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
class function TcxUltraFlatLookAndFeelPainter.DefaultHeaderTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
class function TcxUltraFlatLookAndFeelPainter.DefaultHeaderColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawButton(ACanvas: TcxCanvas; R: TRect; const ACaption: string; AState: TcxButtonState; ADrawBorder: Boolean = True;
       AColor: TColor = clDefault; ATextColor: TColor = clDefault);
var
  Buffer: TBitMap;
  C: TColor;
