...
uses
  ...
  StdCtrls, ImgList, spEffBmp, SkinHint, spPngImageList;
...
procedure TspSkinOfficeListBox.CMFocusChanged(var Message: TCMFocusChanged);
begin
  inherited;
  RePaint;
end;
...
procedure TspSkinHorzListBox.CMFocusChanged(var Message: TCMFocusChanged);
begin
  inherited;
  RePaint;
end;
