...
uses
  ...
  cxLookAndFeelPainters, cxGraphics, cxClasses, ImgList, dxCore, SkinData;

type

  { TcxdsaLookAndFeelPainter }
  TcxdsaLookAndFeelPainter = class(TcxStandardLookAndFeelPainter)
  protected
  ...
  var
    DevExSkinData: TspSkinData = nil;

implementation

uses
  cxControls, cxLookAndFeels, dxSkinInfo,
    dxThemeConsts, Math, cxDrawTextUtils, spUtils, spEffBmp;
...
begin
 ...
 if I <> -1 then ButtonData := TspDataSkinButtonControl(DevExSkinData.CtrlList[I]) else Exit;
...
function TcxdsaLookAndFeelPainter.LookAndFeelName: string;
begin
  Result := s_DSFSkin;
end;

function TcxdsaLookAndFeelPainter.LookAndFeelStyle: TcxLookAndFeelStyle;
begin
  Result := lfsSkin;
end;

function TcxdsaLookAndFeelPainter.DefaultEditorBackgroundColor(AIsDisabled: Boolean): TColor;
begin
...
function TcxdsaLookAndFeelPainter.DefaultEditorBackgroundColorEx(AKind: TcxEditStateColorKind): TColor; 
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cWindow
...
function TcxdsaLookAndFeelPainter.DefaultEditorTextColor(AIsDisabled: Boolean): TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
function TcxdsaLookAndFeelPainter.DefaultEditorTextColorEx(AKind: TcxEditStateColorKind): TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cWindowText
...
function TcxdsaLookAndFeelPainter.DefaultSelectionTextColor: TColor;
begin
   if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
function TcxdsaLookAndFeelPainter.DefaultSelectionColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
function TcxdsaLookAndFeelPainter.DefaultInactiveColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
function TcxdsaLookAndFeelPainter.DefaultInactiveTextColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
procedure TcxdsaLookAndFeelPainter.DrawEditorButton(ACanvas: TcxCanvas; const ARect: TRect;
      AButtonKind: TcxEditBtnKind; AState: TcxButtonState;
...
begin
  ...
  case AButtonKind of
   cxbkComboBtn:
     spUtils.DrawArrowImage(Buffer.Canvas, R, C, 4);
   cxbkSpinUpBtn:
     spUtils.DrawArrowImage(Buffer.Canvas, R, C, 3);
   cxbkSpinDownBtn:
     spUtils.DrawArrowImage(Buffer.Canvas, R, C, 4);
   cxbkSpinLeftBtn:
     spUtils.DrawArrowImage(Buffer.Canvas, R, C, 1);
   cxbkSpinRightBtn:
     spUtils.DrawArrowImage(Buffer.Canvas, R, C, 2);
   cxbkEllipsisBtn:
...
procedure TcxdsaLookAndFeelPainter.DrawTab(ACanvas: TcxCanvas; R: TRect; ABorders: TcxBorders;
      const AText: string; AState: TcxButtonState; AVertical: Boolean; AFont: TFont;
...
function TcxdsaLookAndFeelPainter.DefaultTabColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.DefaultTabTextColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnText
...
function TcxdsaLookAndFeelPainter.DefaultTabsBackgroundColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.DefaultDateNavigatorHeaderColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.DefaultSizeGripAreaColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.FooterSeparatorColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
...
function TcxdsaLookAndFeelPainter.DefaultDateNavigatorSelectionColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cHighlight
...
function TcxdsaLookAndFeelPainter.DefaultDateNavigatorSelectionTextColor: TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cHighlightText
...
procedure TcxdsaLookAndFeelPainter.DrawSmallExpandButton(ACanvas: TcxCanvas;
  R: TRect; AExpanded: Boolean; ABorderColor: TColor; AColor: TColor = clDefault);
begin
  DrawExpandButton(ACanvas, R, AExpanded, AColor);
end;

procedure TcxdsaLookAndFeelPainter.DrawFilterCloseButton(ACanvas: TcxCanvas;
...
procedure TcxdsaLookAndFeelPainter.DrawRadioButton(ACanvas: TcxCanvas; X, Y: Integer;
      AButtonState: TcxButtonState; AChecked, AFocused: Boolean;
...
var
  I: Integer;
  ButtonData: TspDataSkinCheckRadioControl;
  Picture: TBitmap;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    begin
      ...
      if I <> -1 then ButtonData := TspDataSkinCheckRadioControl(DevExSkinData.CtrlList[I]) else Exit;
...
function TcxdsaLookAndFeelPainter.RadioButtonBodyColor(AState: TcxButtonState): TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    Result := DevExSkindata.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.RadioButtonSize: TSize;
var
  I: Integer;
  ButtonData: TspDataSkinCheckRadioControl;
begin
...
function TcxdsaLookAndFeelPainter.CheckButtonSize: TSize; 
var
  I: Integer;
  ButtonData: TspDataSkinCheckRadioControl;
begin
...
procedure TcxdsaLookAndFeelPainter.DrawCheckButton(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
...
procedure TcxdsaLookAndFeelPainter.DrawCheckButton(ACanvas: TcxCanvas; R: TRect;
...
function TcxdsaLookAndFeelPainter.CheckButtonColor(AState: TcxButtonState): TColor;
begin
  if (DevExSkindata <> nil) and (not DevExSkindata.Empty)
  then
    begin
...
procedure TcxdsaLookAndFeelPainter.DrawHeaderPressed(ACanvas: TcxCanvas;
  const ABounds: TRect);
begin
  if (DevExSkindata = nil) or DevExSkindata.Empty then inherited;
end;

procedure TcxdsaLookAndFeelPainter.DrawHeader(ACanvas: TcxCanvas;
  const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors; ABorders: TcxBorders;
  AState: TcxButtonState; AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
  AMultiLine, AShowEndEllipsis: Boolean; const AText: string; AFont: TFont;
  ATextColor, ABkColor: TColor; AOnDrawBackground: TcxDrawBackgroundEvent = nil;
...
procedure TcxdsaLookAndFeelPainter.DrawContent1(ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect; AState: Integer;
      AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil; AIsFooter: Boolean = False);
const
...
function TcxdsaLookAndFeelPainter.DefaultGridLineColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    begin
...
function TcxdsaLookAndFeelPainter.DefaultFilterBoxColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
function TcxdsaLookAndFeelPainter.DefaultFilterBoxTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnHighLight
...
function TcxdsaLookAndFeelPainter.DefaultFooterColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.DefaultFooterTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
function TcxdsaLookAndFeelPainter.DefaultGroupByBoxColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
function TcxdsaLookAndFeelPainter.DefaultGroupByBoxTextColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnHighLight
...
function TcxdsaLookAndFeelPainter.DefaultContentColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cWindow
...
function TcxdsaLookAndFeelPainter.DefaultContentTextColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cWindowText
...
function TcxdsaLookAndFeelPainter.DefaultGroupColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.DefaultGroupTextColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
function TcxdsaLookAndFeelPainter.DefaultSchedulerBorderColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
function TcxdsaLookAndFeelPainter.DefaultHeaderBackgroundColor: TColor;
begin
   if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
function TcxdsaLookAndFeelPainter.DefaultHeaderBackgroundTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
function TcxdsaLookAndFeelPainter.DefaultHeaderTextColor: TColor; 
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnText
...
function TcxdsaLookAndFeelPainter.DefaultHeaderColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cBtnFace
...
procedure TcxdsaLookAndFeelPainter.DrawButton(ACanvas: TcxCanvas; R: TRect; const ACaption: string;
      AState: TcxButtonState; ADrawBorder: Boolean = True; AColor: TColor = clDefault;
...
function TcxdsaLookAndFeelPainter.BorderHighlightColor: TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    Result := DevExSkinData.SkinColors.cHighLight
...
function TcxdsaLookAndFeelPainter.BorderSize: Integer;
begin
  Result := 1;
end;

procedure TcxdsaLookAndFeelPainter.DrawContainerBorder(ACanvas: TcxCanvas; const R: TRect; AStyle: TcxContainerBorderStyle;
...
procedure TcxdsaLookAndFeelPainter.DrawBorder(ACanvas: TcxCanvas; R: TRect);
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
...
function TcxdsaLookAndFeelPainter.ButtonBorderSize(AState: TcxButtonState = cxbsNormal): Integer;
begin
  if AState = cxbsDefault then Result := 2 else Result := 1;
end;

function TcxdsaLookAndFeelPainter.ButtonColor(AState: TcxButtonState): TColor;
begin
  if (DevExSkinData <> nil) and not (DevExSkinData.Empty)
  then
    begin
...
function TcxdsaLookAndFeelPainter.ButtonFocusRect(ACanvas: TcxCanvas; R: TRect): TRect;
begin
  Result := R;
...
function TcxdsaLookAndFeelPainter.ButtonGroupBorderSizes(AButtonCount,
...
function TcxdsaLookAndFeelPainter.ButtonSymbolColor(
...
function TcxdsaLookAndFeelPainter.ButtonSymbolState(AState: TcxButtonState): TcxButtonState;
begin
  Result := cxbsNormal;
end;

function TcxdsaLookAndFeelPainter.ButtonTextOffset: Integer;
begin
  Result := 2;
end;

function TcxdsaLookAndFeelPainter.ButtonTextShift: Integer;
begin
  Result := 0;
end;

procedure TcxdsaLookAndFeelPainter.DrawButtonBorder(ACanvas: TcxCanvas; R: TRect;
...
procedure TcxdsaLookAndFeelPainter.DrawButtonInGroup(ACanvas: TcxCanvas;
...
procedure TcxdsaLookAndFeelPainter.DrawButtonGroupBorder(ACanvas: TcxCanvas;
...
procedure TcxdsaLookAndFeelPainter.DrawExpandButton(ACanvas: TcxCanvas;
...
procedure TcxdsaLookAndFeelPainter.DrawHeaderControlSectionBorder(
...
procedure TcxdsaLookAndFeelPainter.DrawHeaderControlSectionContent(
...
function TcxdsaLookAndFeelPainter.ExpandButtonSize: Integer;
begin
  Result := 11;
end;

function TcxdsaLookAndFeelPainter.IsButtonHotTrack: Boolean;
begin
  Result := True;
end;

procedure TcxdsaLookAndFeelPainter.DrawCheckBorder(ACanvas: TcxCanvas; R: TRect;
  AState: TcxButtonState);
begin
...
procedure TcxdsaLookAndFeelPainter.DrawHeaderBorder(ACanvas: TcxCanvas;
...
procedure TcxdsaLookAndFeelPainter.DrawHeaderEx(ACanvas: TcxCanvas;
  const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors; ABorders: TcxBorders;
  AState: TcxButtonState; AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
  AMultiLine, AShowEndEllipsis: Boolean; const AText: string; AFont: TFont;
  ATextColor, ABkColor: TColor; AOnDrawBackground: TcxDrawBackgroundEvent = nil);
...
procedure TcxdsaLookAndFeelPainter.DrawSortingMark(ACanvas: TcxCanvas;
...
function TcxdsaLookAndFeelPainter.HeaderBorders(ANeighbors: TcxNeighbors): TcxBorders;
begin
...
function TcxdsaLookAndFeelPainter.HeaderBorderSize: Integer;
begin
  Result := 1;
end;

function TcxdsaLookAndFeelPainter.SortingMarkSize: TPoint;
begin
  Result := Point(7, 8);
end;

procedure TcxdsaLookAndFeelPainter.DrawFooterBorder(ACanvas: TcxCanvas;
  const R: TRect);
begin
...
procedure TcxdsaLookAndFeelPainter.DrawFooterCellBorder(ACanvas: TcxCanvas;
  const R: TRect);
begin
  ACanvas.FrameRect(R, FooterSeparatorColor);
end;

function TcxdsaLookAndFeelPainter.FooterBorders: TcxBorders;
begin
  Result := [bRight, bBottom];
end;

function TcxdsaLookAndFeelPainter.FooterBorderSize: Integer;
begin
  Result := 1;
end;

function TcxdsaLookAndFeelPainter.FooterCellBorderSize: Integer;
begin
  Result := 1;
end;

function TcxdsaLookAndFeelPainter.FooterCellOffset: Integer;
begin
  Result := 2;
end;

procedure TcxdsaLookAndFeelPainter.DrawFilterDropDownButton(ACanvas: TcxCanvas;
...
function TcxdsaLookAndFeelPainter.FilterCloseButtonSize: TPoint;
begin
  Result := inherited FilterCloseButtonSize;
  Inc(Result.Y);
end;

procedure TcxdsaLookAndFeelPainter.DrawTabBorder(ACanvas: TcxCanvas; R: TRect;
...
procedure TcxdsaLookAndFeelPainter.DrawTabsRoot(ACanvas: TcxCanvas;
...
function TcxdsaLookAndFeelPainter.TabBorderSize(AVertical: Boolean): Integer;
begin
  Result := 1;
end;

procedure TcxdsaLookAndFeelPainter.DrawScrollBarPart(ACanvas: TcxCanvas;
  AHorizontal: Boolean; R: TRect; APart: TcxScrollBarPart; AState: TcxButtonState);
var
  ScrollBarData: TspDataSkinScrollbarControl;
  I, Cnt: Integer;
...
begin
  ...
  then
    begin
      ...
      then
        begin
          ScrollBarData := TspDataSkinScrollbarControl(DevExSkinData.CtrlList[I]);
...
function TcxdsaLookAndFeelPainter.FilterDropDownButtonBorderColor(AState: TcxButtonState): TColor;
begin
  if (DevExSkinData <> nil) and not DevExSkinData.Empty
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
function TcxdsaLookAndFeelPainter.TabBorderHighlightColor: TColor;
begin
  if (DevExSkinData <> nil) and not DevExSkinData.Empty
  then
    Result := DevExSkinData.SkinColors.cBtnHighLight
...
function TcxdsaLookAndFeelPainter.TabBorderDarkColor: TColor;
begin
   if (DevExSkinData <> nil) and not DevExSkinData.Empty
  then
    Result := DevExSkinData.SkinColors.cBtnShadow
...
procedure TcxdsaLookAndFeelPainter.DrawSchedulerNavigatorButton(
  ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState);
begin
  DrawButton(ACanvas, R, '', AState, AState in [cxbsHot, cxbsPressed]);
end;

procedure TcxdsaLookAndFeelPainter.DrawSchedulerSplitterBorder(
...
begin
  cxLookAndFeelPaintersManager.Register(TcxdsaLookAndFeelPainter.Create);
end;
