How to add skin support for QuantumGrid and other DevExpress controls (V2011-2012):

1. Install SkinAdapter VCL.
2. Enable {$DEFINE DEVEX_SUPPORT} directive in bsaadapter.pas.
3. Add dsaDevExSkin.pas to the DynamicSkinForm VCL package and recompile it.
4. Set LookAndFeel.Skin property to "DSFSkin" in DevExpress controls.
