...
3. Use TdsaSkinAdapter.OnChangeSkinData event 
   to apply skincolor to VTV.Header.Background and VTV.Header.Font.Color properties:

procedure TForm1.dsaSkinAdapter1ChangeSkinData(Sender: TObject);
begin
  VTV.Header.Background := spSkinData1.SkinColors.cBtnFace;
  VTV.Header.Font.Color := spSkinData1.SkinColors.cBtnText;
  // to adapt color of VTV use:
  VTV.Color := spSkinData1.SkinColors.cWindow; 
end;
