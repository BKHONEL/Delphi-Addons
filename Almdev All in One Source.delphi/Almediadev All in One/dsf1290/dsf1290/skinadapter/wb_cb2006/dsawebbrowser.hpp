...
// (DO NOT EDIT: machine generated header) 'Dsawebbrowser.pas' rev: 10.00

#ifndef DsawebbrowserHPP
#define DsawebbrowserHPP
...
#include <Dsaadapter.hpp>	// Pascal unit
...
class DELPHICLASS TspScrollWinControl;
class PASCALIMPLEMENTATION TspScrollWinControl : public Controls::TWinControl 
{
...
public:
	...
	__fastcall virtual TspScrollWinControl(Classes::TComponent* AOwner);
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TspScrollWinControl(HWND ParentWindow) : Controls::TWinControl(ParentWindow) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TWinControl.Destroy */ inline __fastcall virtual ~TspScrollWinControl(void) { }
	#pragma option pop
	
};


class DELPHICLASS TdsaWebBrowser;
class PASCALIMPLEMENTATION TdsaWebBrowser : public Shdocvw::TWebBrowser 
{
	typedef Shdocvw::TWebBrowser inherited;
	
private:
	bool FFrameDoc;
	TspScrollWinControl* FVScrollWnd;
	TspScrollWinControl* FHScrollWnd;
	TspScrollWinControl* FSizeGrip;
	Skinctrls::TspSkinScrollBar* FVScroll;
	Skinctrls::TspSkinScrollBar* FHScroll;
	...
	void __fastcall SetSkinData(const Skindata::TspSkinData* Value);
...
public:
	__fastcall virtual TdsaWebBrowser(Classes::TComponent* AOwner);
	__fastcall virtual ~TdsaWebBrowser(void);
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TdsaWebBrowser(HWND ParentWindow) : Shdocvw::TWebBrowser(ParentWindow) { }
	#pragma option pop
	
private:
	void *__IDocHostUIHandler;	/* Dsawebbrowser::IDocHostUIHandler */
