...
uses Windows, SysUtils, sCalcUnit, Messages, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls, Menus,
...
begin
  ...
  if IsModal then FCalc.ShowModal else FCalc.Show;
end;
...
begin
  inherited;
  if FCaption = '' then FCaption := acs_Calculator;
end;
