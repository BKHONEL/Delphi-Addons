  ...
  if (SkinData.SkinManager <> nil) and (SkinData.SkinIndex > -1) then begin
    with SkinData.SkinManager.gd[SkinData.SkinIndex] do begin
      if (SkinData.BorderIndex > -1) then begin
        ...
        if ((SkinData.SkinManager.ma[SkinData.BorderIndex].WL + SkinData.SkinManager.ma[SkinData.BorderIndex].WR > 20) or
...
begin
  ...
  if (cd <> nil) and (cd is TsCommonData) and (TsCommonData(cd).SkinIndex >= 0) then begin
