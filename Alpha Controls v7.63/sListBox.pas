...
//    if bSelected
//      then BitBlt(Canvas.Handle, Rect.Left, Rect.Top, Bmp.Width, Bmp.Height, Bmp.Canvas.Handle, 0, 0, SRCCOPY)
//      else
...
{$ENDIF}
  ...
  case Message.Msg of
    ...
    CM_FONTCHANGED : if (Style = lbStandard) and not (csLoading in ComponentState) and not (csFreeNotification in ComponentState) and HandleAllocated then begin
      Canvas.Font.Assign(Font);
