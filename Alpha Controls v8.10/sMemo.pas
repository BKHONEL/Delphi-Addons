    ...
    case Message.Msg of
      WM_PAINT : begin
        ...
        if not SkinData.CustomColor and (SkinData.SkinIndex >= 0) then begin
          if (Color <> SkinData.SkinManager.gd[SkinData.SkinIndex].Props[0].Color) then Color := SkinData.SkinManager.gd[SkinData.SkinIndex].Props[0].Color;
          if (Font.Color <> SkinData.SkinManager.gd[SkinData.SkinIndex].Props[0].FontColor.Color) then Font.Color := SkinData.SkinManager.gd[SkinData.SkinIndex].Props[0].FontColor.Color;
        end;
