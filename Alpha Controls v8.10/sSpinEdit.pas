...
begin
  ...
  if BorderStyle = bsSingle
    then PaintItem(SkinData, GetParentCache(SkinData), True, integer(ControlIsActive(SkinData)), Rect(0, 0, Width, Height), Point(Left, top), SkinData.FCacheBmp, False)
    else PaintItemBG(SkinData, GetParentCache(SkinData), integer(ControlIsActive(SkinData)), Rect(0, 0, Width, Height), Point(Left, Top), SkinData.FCacheBmp);
