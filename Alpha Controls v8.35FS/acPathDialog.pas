...
uses
  ...
  sSkinProvider, sEdit, sTreeView, sScrollBox, ImgList, sLabel, sConst, FileCtrl,
  acAlphaImageList;
...
uses acntUtils, Commctrl, sStrings, acSBUtils, TypInfo, sSpeedButton, ShlObj, ShellAPI, sSkinProps;
