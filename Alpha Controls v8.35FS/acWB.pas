...
{$IFNDEF DELPHI_XE2}
    TBeforeNavigate2 = procedure (Sender: TObject; const pDisp: IDispatch; var URL, Flags, TargetFrameName, PostData, Headers: OleVariant; var Cancel: WordBool) of object;
{$ELSE}
    TBeforeNavigate2 = procedure (ASender: TObject; const pDisp: IDispatch; const URL: OleVariant; const Flags: OleVariant; const TargetFrameName: OleVariant;
                                 const PostData: OleVariant; const Headers: OleVariant; var Cancel: WordBool) of object;
{$ENDIF}                                 
...
begin
  ...
  if SkinData.FOwnerControl <> nil then begin
    ...
    if Assigned(WB.OnBeforeNavigate2) then OldBeforeNavigate2 := WB.OnBeforeNavigate2;
...
{$IFNDEF DELPHI_XE2}
      OldBeforeNavigate2(Sender, pDisp, URL, Flags, TargetFrameName, PostData, Headers, Cancel);
{$ELSE}
