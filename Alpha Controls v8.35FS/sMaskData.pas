...
uses Windows, Graphics, sConst, acTinyJpg;
...
type
  ...
  TsMaskData = record
    ...
    DrawMode     : smallint;          // Fill type if ImgType is texture (0-tiled, 1-stretched, 2-tiled horizontal top, 3-tiled vertical left, 4-stretched horizontal top,
                                      ...
                                      //   B-discrete tiled hor. top, C-discrete tiled vert. left, D-discrete tiled hor. bottom, E-discrete tiled vert. right)
    ...
    CornerType   : smallint;          // 1 - have transparent prixels, 2 - control region must be changed 
  end;
...
//    TextureHot    : integer;               // Hot Texture
