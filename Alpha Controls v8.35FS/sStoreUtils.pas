...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, {$IFDEF DELPHI6UP} Types, {$ENDIF}{$IFDEF DELPHI_XE3}UITypes, {$ENDIF}
  ToolWin, ComCtrls, ExtCtrls, ActnList, StdCtrls, acTinyJpg,
