...
//        SavedCanvas := DBCtrlGrid.Canvas;
//        DBCtrlGrid.Canvas := FCommonData.FCacheBmp.Canvas;
//        PaintPanel(DataLink.ActiveRecord);
//        DBCtrlGrid.Canvas := SavedCanvas;
      end
    end;
    SetParentUpdated(Self);
    BitBlt(DC, 0, 0, Width, Height, FCommonData.FCacheBmp.Canvas.Handle, 0, 0, SRCCOPY);
    if (DBCtrlGrid.DataSource <> nil)
      then DBCtrlGrid.PaintPanel(DBCtrlGrid.DataLink.ActiveRecord);
