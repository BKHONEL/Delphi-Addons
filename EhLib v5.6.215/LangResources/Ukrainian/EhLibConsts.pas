...
resourcestring
  ...
  SFindDialogStringNotFoundMessageEh = 'Рядок "%s" не знайдена';
  ...
  SSTFilterListItem_CustomFilter = '(Користувацький фільтр...)';
  ...
  SSimpFilter_in_list             = 'в списку';
  SSimpFilter_not_in_list         = 'не в списку';
  SSimpFilter_is_blank            = 'пусті';
  SSimpFilter_is_not_blank        = 'не пусті';

  SGroupingPanelText = 'Перетяніть сюди заголовок стовпця щоб згрупувати дані за стовпцем';
