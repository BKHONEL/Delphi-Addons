...
//  Indent := 0;
  ...
  begin
    ...
    begin
      if inherited UseRightToLeftAlignment then
      begin
        EditButtonControl.SetBounds(Indent - EditButtonControl.Width, ButtonRect.Top, EditButtonControl.Width, MinButtonHeight);
...
//  FButtonWidth := Indent;
  ...
  begin
    if inherited UseRightToLeftAlignment then
      FButtonsPanel.SetBounds(0, 0, FButtonWidth, MinButtonHeight)
    else
