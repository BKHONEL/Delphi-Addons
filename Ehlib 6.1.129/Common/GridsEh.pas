...
begin
  ...
  if not (goHorzLine in Options) and (ACol >= ColCount) then
...
//      RestoreDataDrawOriginClipRegion(RCR);
      ...
      DrawGridContraLineEh(DrawInfo, cbtLeftEh,
        ...
        GetCellBorderColor(ColCount, TopRow, cbtLeftEh), Color, Canvas, DrawLinesInfo);

{      DrawFirstContraLine(Horz.ContraExtent, Vert.OutViewVisCellStart,
        Horz.ContraExtent, Vert.GridBoundary,
        GetCellBorderColor(ColCount, TopRow, cbtLeftEh));}
