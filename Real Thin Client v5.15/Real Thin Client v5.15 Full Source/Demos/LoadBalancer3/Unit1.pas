...
type
  ...
  public
    ...
    procedure ServerInfoFromLine(lin:AnsiString;
                                 var VirtualHost,VirtualPath,
                                 ServerAddr,ServerPort,ServerURI:AnsiString;
    ...
    function ServerLineFromInfo(VirtualHost,VirtualPath,
                                ...
                                AppType,BalanceType,RequestOrder:integer):AnsiString;

    procedure UpdateServerDetails;
    procedure UpdateServerList;

    function SetupBalancer(const MyVirtualHost, MyVirtualPath:AnsiString;
...
procedure TRtcLoadBalancerMainForm.ServerInfoFromLine(lin: AnsiString;
    var VirtualHost, VirtualPath, ServerAddr, ServerPort, ServerURI: AnsiString;
...
function TRtcLoadBalancerMainForm.SetupBalancer(const MyVirtualHost, MyVirtualPath: AnsiString;
    MyAppType, MyBlanceType, MyReqOrder: integer): TRtcLoadBalancer;
  var
    a:integer;
  begin
...
procedure TRtcLoadBalancerMainForm.CreateBalancers;
  var
    ...
    i:integer;
    tmpHost,tmpPath,
    tmpAddr,tmpPort,tmpUri:AnsiString;
