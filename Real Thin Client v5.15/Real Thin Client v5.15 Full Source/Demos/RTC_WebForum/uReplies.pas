...
type
  ...
  private
    ...
    function GetMessages(Reply: PReplyRecord): AnsiString;
  protected
  ...
  public
    ...
    function New(const Msg : AnsiString) : PReplyRecord;
    ...
    property Messages[Reply : PReplyRecord] : AnsiString read GetMessages;
  end;
...
function TRepliesTable.New(const Msg : AnsiString): PReplyRecord;
var
  MsgSize : integer;
begin
  MsgSize := Length(Msg);
...
function TRepliesTable.GetMessages(Reply: PReplyRecord): AnsiString;
begin
