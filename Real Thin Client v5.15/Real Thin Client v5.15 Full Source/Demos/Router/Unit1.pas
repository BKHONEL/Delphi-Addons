...
uses
  ...
  rtcLog, rtcSyncObjs, StdCtrls, Spin, memXObjList, rtcFastStrings,
  ...
  try
    ...
    try
      if not Server.isListening then
        ...
        FCliServerAddr:=AnsiString(eToAddr.Text);
        FCliServerPort:=AnsiString(eToPort.Text);
...
procedure TRtcRouterMainForm.GetDataRequest(Sender:TRtcDataServer; var DataRequest: TRtcDataRequest; const tip:AnsiString);
  var
    makenew:boolean;
    Cli:TRtcHttpClient;
  begin
