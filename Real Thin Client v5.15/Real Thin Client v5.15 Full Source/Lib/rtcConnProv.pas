...
type
  ...
  public
    ...
    procedure Write(const s:AnsiString; SendNow:boolean=True); virtual; abstract;
    function Read:AnsiString; virtual; abstract;

    function GetPeerAddr:AnsiString; virtual; abstract;
    function GetPeerPort:AnsiString; virtual; abstract;
    function GetLocalAddr:AnsiString; virtual; abstract;
    function GetLocalPort:AnsiString; virtual; abstract;
    ...
    procedure SetAddr(const val:AnsiString);
    procedure SetPort(const val:AnsiString);
  ...
  protected
    ...
    procedure SetLocalAddr(const Value: AnsiString);
    procedure SetLocalPort(const Value: AnsiString);
    procedure SetPeerAddr(const Value: AnsiString);
    procedure SetPeerPort(const Value: AnsiString);
    procedure SetState(value:TRtcConnectionState);

    property State:TRtcConnectionState read GetState write SetState;
    property PeerAddr:AnsiString read GetPeerAddr write SetPeerAddr;
    property PeerPort:AnsiString read GetPeerPort write SetPeerPort;
    property LocalAddr:AnsiString read GetLocalAddr write SetLocalAddr;
    property LocalPort:AnsiString read GetLocalPort write SetLocalPort;
...
function TRtcConnectionProvider.GetAddr: AnsiString;
  begin
  Result:=FAddr;
  end;

function TRtcConnectionProvider.GetPort: AnsiString;
  begin
  Result:=FPort;
  end;

procedure TRtcConnectionProvider.SetAddr(const val: AnsiString);
  begin
  FAddr:=val;
  end;
...
procedure TRtcConnectionProvider.SetPort(const val: AnsiString);
  begin
  FPort:=val;
  end;
...
function TRtcBasicClientProvider.GetLocalAddr: AnsiString;
  begin
  Result:=FLocalAddr;
  end;

function TRtcBasicClientProvider.GetLocalPort: AnsiString;
  begin
  Result:=FLocalPort;
  end;

function TRtcBasicClientProvider.GetPeerAddr: AnsiString;
  begin
  Result:=FPeerAddr;
  end;

function TRtcBasicClientProvider.GetPeerPort: AnsiString;
  begin
  Result:=FPeerPort;
  end;
...
procedure TRtcBasicClientProvider.SetLocalAddr(const Value: AnsiString);
  begin
  FLocalAddr:=Value;
  end;

procedure TRtcBasicClientProvider.SetLocalPort(const Value: AnsiString);
  begin
  FLocalPort:=Value;
  end;

procedure TRtcBasicClientProvider.SetPeerAddr(const Value: AnsiString);
  begin
  FPeerAddr:=Value;
  end;

procedure TRtcBasicClientProvider.SetPeerPort(const Value: AnsiString);
  begin
  FPeerPort:=Value;
  end;
...
function TRtcBasicServerProvider.GetLocalAddr: AnsiString;
  begin
  Result:=FLocalAddr;
  end;

function TRtcBasicServerProvider.GetLocalPort: AnsiString;
  begin
  Result:=FLocalPort;
  end;

function TRtcBasicServerProvider.GetPeerAddr: AnsiString;
  begin
  Result:=FPeerAddr;
  end;

function TRtcBasicServerProvider.GetPeerPort: AnsiString;
  begin
  Result:=FPeerPort;
  end;
...
procedure TRtcBasicServerProvider.SetLocalAddr(const Value: AnsiString);
  begin
  FLocalAddr:=Value;
  end;

procedure TRtcBasicServerProvider.SetLocalPort(const Value: AnsiString);
  begin
  FLocalPort:=Value;
  end;

procedure TRtcBasicServerProvider.SetPeerAddr(const Value: AnsiString);
  begin
  FPeerAddr:=Value;
  end;

procedure TRtcBasicServerProvider.SetPeerPort(const Value: AnsiString);
  begin
  FPeerPort:=Value;
  end;
