...
type
  ...
  public
    ...
    procedure Open(const _ID:AnsiString); virtual;
...
procedure TRtcClientSession.Open(const _ID: AnsiString);
  begin
  if FID<>'' then Close;
  Clear;
  FID:=_ID;
