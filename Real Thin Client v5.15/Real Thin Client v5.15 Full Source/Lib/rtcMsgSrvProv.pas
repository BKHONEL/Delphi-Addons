...
procedure TRtcMessageServerProvider.WriteHeader(const Header_Text:AnsiString);
  var
    s:AnsiString;
  begin
  if FHeaderOut then
...
procedure TRtcMessageServerProvider.Write(const ResultData: AnsiString; SendNow:boolean=True);
  var
    len:cardinal;
  begin
...
function TRtcMessageServerProvider.Read: AnsiString;
  begin
