...
type
  ...
  public
    ...
    function AfterConnectEx(var ConnCryptObj:TObject;
                            ...
                            const RemoteAddr, RemoteIP:AnsiString):TRtcCryptPluginState; virtual; abstract;
    ...
    function BeforeDisconnectEx(var ConnCryptObj:TObject;
                                var OutData:AnsiString):TRtcCryptPluginState;  virtual; abstract;
    ...
    function DataReceivedEx(var ConnCryptObj:TObject;
                            ...
                            var OutData:AnsiString;
                            var OutPlainText:AnsiString):TRtcCryptPluginState;  virtual; abstract;
  ...
  public
    function AfterConnectEx(var ConnCryptObj:TObject;
                            var OutData:AnsiString;
                            Protocol: TRtcCryptPluginProtocol;
                            const RemoteAddr, RemoteIP:AnsiString):TRtcCryptPluginState; override;

    function BeforeDisconnectEx(var ConnCryptObj:TObject;
                                var OutData:AnsiString):TRtcCryptPluginState;  override;
    ...
    function DataReceivedEx(var ConnCryptObj:TObject;
                            const InData:AnsiString;
                            var OutData:AnsiString;
                            var OutPlainText:AnsiString):TRtcCryptPluginState;  override;
...
type
  ...
  public
    Protocol:TRtcCryptPluginProtocol;
    RemoteAddr,RemoteIP:AnsiString;
    end;

function TRtcDummyCryptPlugin.AfterConnectEx(var ConnCryptObj:TObject; var OutData:AnsiString;
                                             Protocol: TRtcCryptPluginProtocol;
...
function TRtcDummyCryptPlugin.DataReceivedEx(var ConnCryptObj: TObject; const InData: AnsiString; var OutData, OutPlainText: AnsiString): TRtcCryptPluginState;
  begin
  OutPlainText := InData;
  Result:=cpsReady;
  end;

function TRtcDummyCryptPlugin.DataToSendEx(var ConnCryptObj: TObject; const InData: AnsiString; var OutData: AnsiString): TRtcCryptPluginState;
  begin
  OutData:=InData;
  Result:=cpsReady;
  end;

function TRtcDummyCryptPlugin.BeforeDisconnectEx(var ConnCryptObj: TObject; var OutData: AnsiString): TRtcCryptPluginState;
  begin
  Result:=cpsReady;
  end;
