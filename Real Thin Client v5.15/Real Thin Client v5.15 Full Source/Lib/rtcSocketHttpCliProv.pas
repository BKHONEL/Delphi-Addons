...
procedure TRtcSocketHttpClientProvider.WriteHeader(const Header_Text:AnsiString; SendNow:boolean=True);
  var
    s:AnsiString;
  begin
  if FHeaderOut then
...
procedure TRtcSocketHttpClientProvider.Write(const ResultData: AnsiString; SendNow:boolean=True);
  begin
...
function TRtcSocketHttpClientProvider.Read: AnsiString;
  begin
