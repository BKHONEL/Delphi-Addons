...
type
  { @Abstract(Server Connection component for UDP communication using raw data)
    ...
    @html(<b>function Read:AnsiString;</b><br>)
      ...
      you have to store the AnsiString received from Read, before
    ...
    @html(<b>procedure Write(const s:AnsiString='');</b><br>)
      Use Write to send one datagram out. Write for UDP will put the
      datagram AnsiString into the sending buffer and return immediatelly.
      @html(<br><br>)
  ...
  published
    ...
    property UdpMultiCastAddr:AnsiString read FMultiCastAddrStr write FMultiCastAddrStr;
